            ...
            <main className='row'>
                <nav className={`column ${isShowNav ? 'show' : ''}`}>
                    <div>
                        ...
                        <Link to='/' className="row" onClick={() => {setisShowNav(!isShowNav); document.querySelector('.menu').style.transform = `${isShowNav ? 'rotate(0deg)' : 'rotate(180deg)'}`}}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 17">
                                <path d="M8 17V11H12V17H17V9H20L10 0L0 9H3V17H8Z" />
                            </svg>
                            Home
                    </Link>
                        <Link to='/chat' className="row" onClick={() => {setisShowNav(!isShowNav); document.querySelector('.menu').style.transform = `${isShowNav ? 'rotate(0deg)' : 'rotate(180deg)'}`}}>
                        ...
                        <Link to='/settings' className="row" onClick={() => {setisShowNav(!isShowNav); document.querySelector('.menu').style.transform = `${isShowNav ? 'rotate(0deg)' : 'rotate(180deg)'}`}}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <a className="row" onClick={() => {document.cookie = 'Exit=true'; document.location.reload()}}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
